...
class GaitController:
    def __init__(self, config):
        """
        Gait controller for Jax.
        Logic is based on the configuration timing parameters for stance and swing phases.
        """
        self.config = config
    ...
    def contacts(self, ticks):
        ...
        -------
        numpy array (4,)
            Numpy vector with 0 indicating flight (swing) and 1 indicating stance.
        """
